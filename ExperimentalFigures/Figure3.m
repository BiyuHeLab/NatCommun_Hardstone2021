...
%%
disp('')
disp(['Cube: Occipital-> Frontal Preferred (' num2str(Output.Cube.GreaterGCPreferredTrials_LobeCount(1,4)) ',' num2str(Output.Cube.GreaterGCPreferredTrials_LobeCount(4,1)) ') ' num2str(Output.Cube.GreaterGCPreferredTrials_LobePValue(1,4))]);
disp(['Cube: Occipital-> Frontal NonPreferred (' num2str(Output.Cube.GreaterGCNonPreferredTrials_LobeCount(1,4)) ',' num2str(Output.Cube.GreaterGCNonPreferredTrials_LobeCount(4,1)) ') ' num2str(Output.Cube.GreaterGCNonPreferredTrials_LobePValue(1,4))]);
