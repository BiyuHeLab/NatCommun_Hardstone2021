...
for i_image = 1:length(images)
    ...
    Rank_PreferredMinusPreferred_ToFrom = Data.Subjects.Granger.Preferred_NonPreferred_MatchedDistance.(imageName).Temporal.Rank_PreferredMinusNonPreferred_IndividualBias;
...
disp('')
Output.Cube.GreaterGCInPreferred_ToFrom_LobeZValue
disp(['Cube: Occipital -> Temporal Preferred (' num2str(Output.Cube.GreaterGCInPreferred_ToFrom_LobeCount(2,4)) ',' num2str(Output.Cube.GreaterGCInPreferred_ToFrom_LobeCount(4,2)) ') ' num2str(Output.Cube.GreaterGCInPreferred_ToFrom_LobePValue(2,4))]);
disp(['Cube: Occipital -> Temporal NonPreferred (' num2str(Output.Cube.GreaterGCInNonPreferred_ToFrom_LobeCount(2,4)) ',' num2str(Output.Cube.GreaterGCInNonPreferred_ToFrom_LobeCount(4,2)) ') ' num2str(Output.Cube.GreaterGCInNonPreferred_ToFrom_LobePValue(2,4))]);

disp(['Cube: Occipital -> Temporal Preferred (z=' num2str(Output.Cube.GreaterGCInPreferred_ToFrom_LobeZValue(2,4)) ')']);
disp(['Cube: Occipital -> Temporal NonPreferred (z=' num2str(Output.Cube.GreaterGCInNonPreferred_ToFrom_LobeZValue(2,4)) ')']);
